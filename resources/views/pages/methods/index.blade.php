...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">All Methods</h2>
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="javascript:void(0);" data-tw-toggle="modal" data-tw-target="#addNewMethodModal" class="btn btn-primary shadow-md mr-2">Add New Method</a>
    ...
    <div class="intro-y box p-5 mt-5">
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            <form id="tabulatorFilterForm" class="xl:flex sm:mr-auto" >
                <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                    ...
                    <input id="method_name" name="method_name" type="text" class="form-control sm:w-40 2xl:w-full mt-2 sm:mt-0"  placeholder="Search...">
                </div>
                <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div id="methodListTable" class="mt-5 table-report table-report--tabulator"></div>
        </div>
    </div>
    <!-- END: HTML Table Data -->

    <!-- BEGIN: Add Storage Modal -->
    <div id="addNewMethodModal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="#" id="addNewMethodForm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <input id="method_name" name="method_name" type="text" class="form-control" placeholder="Method Name">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="saveMethod" class="btn btn-primary w-auto">
                            Add Method
